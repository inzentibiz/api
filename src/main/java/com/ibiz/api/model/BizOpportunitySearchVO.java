...
public class BizOpportunitySearchVO {
    /**
     * 프로젝트 ID
     */
     ...
     * 사업기회 이관 리스트
     */
    private List<BizOpportunityVO> bizOpportunityTransferList;
    ...
    public String getBefBoptStatNm() {
        return befBoptStatNm;
    }
    public void setBefBoptStatNm(String befBoptStatNm) {
        this.befBoptStatNm = befBoptStatNm;
    }
    ...
    public String getBefWctPrbbNm() {
        return befWctPrbbNm;
    }
    public void setBefWctPrbbNm(String befWctPrbbNm) {
        this.befWctPrbbNm = befWctPrbbNm;
    }
    ...
    public String getBefBexcRoleNm() {
        return befBexcRoleNm;
    }
    public void setBefBexcRoleNm(String befBexcRoleNm) {
        this.befBexcRoleNm = befBexcRoleNm;
    }
    ...
    public List<BizOpportunityVO> getBizOpportunityTransferList() {
        return bizOpportunityTransferList;
    }
    public void setBizOpportunityTransferList(List<BizOpportunityVO> bizOpportunityTransferList) {
    ...
    public String toString() {
        return "BizOpportunitySearchVO [prjtId=" + prjtId + ", prjtSearchId=" + prjtSearchId + ", prjtNm=" + prjtNm
                ...
                + ", period=" + period + ", prjtTypeNm=" + prjtTypeNm + ", bsnsClsfNm=" + bsnsClsfNm + ", cntrDate=" + cntrDate
                + ", cntrTrsfStartYam=" + cntrTrsfStartYam + ", cntrTrsfEndYam=" + cntrTrsfEndYam + ", boptStatNm=" + boptStatNm
                ...
                + bexcRoleCd + ", bexcRoleNm=" + bexcRoleNm + ", putTimeUnitCd=" + putTimeUnitCd + ", putNopCount="
                + putNopCount + ", sumSellAmt=" + sumSellAmt + ", wctPrbbNm=" + wctPrbbNm + ", befBoptStatNm="
                + befBoptStatNm + ", befChgDt=" + befChgDt + ", befCntrBuyAmt=" + befCntrBuyAmt + ", cntrBuyAmt="
                + cntrBuyAmt + ", befCntrYam=" + befCntrYam + ", cntrYam=" + cntrYam + ", befWctPrbbNumVal=" + befWctPrbbNumVal
                + ", wctPrbbNumVal=" + wctPrbbNumVal + ", befWctPrbbNm=" + befWctPrbbNm + ", befFcstRflcYn=" + befFcstRflcYn
                ...
                + ", befBexcRoleNm=" + befBexcRoleNm + ", befPutNopCount=" + befPutNopCount + ", befPutPrbbNopCount="
