...
public class BizOpportunityVO {
     ...
     * 월별 매출매입 리스트
     */
    private List<BizOpportunityAmtVO> bizOpportunityAmtList;

    /**
     * 월별 투입인원 리스트
     */
    private List<BizOpportunityNopVO> bizOpportunityNopList;
    ...
    private SalesActivityVO salesActivityVO;
    ...
    public List<BizOpportunityAmtVO> getBizOpportunityAmtList() {
        return bizOpportunityAmtList;
    }

    public void setBizOpportunityAmtList(List<BizOpportunityAmtVO> bizOpportunityAmtList) {
        this.bizOpportunityAmtList = bizOpportunityAmtList;
    }

    public List<BizOpportunityNopVO> getBizOpportunityNopList() {
        return bizOpportunityNopList;
    }

    public void setBizOpportunityNopList(List<BizOpportunityNopVO> bizOpportunityNopList) {
    ...
    public SalesActivityVO getSalesActivityVO() {
        return salesActivityVO;
    }

    public void setSalesActivityVO(SalesActivityVO salesActivityVO) {
        this.salesActivityVO = salesActivityVO;
    }
}
